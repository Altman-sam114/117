...
flowchart TD
  ...
  Editor --> BodyTextView["MarkdownBodyTextView：UITextView bridge，按需配置 Markdown 输入 traits，去重同步正文、光标/选区和焦点，承载 Tab / Shift-Tab；placeholder 非分配判断"]
...
flowchart LR
  ...
  Body --> BodyText["MarkdownBodyTextView：正文编辑、输入 traits 按需配置和 UTF-16 光标/选区去重同步"]
