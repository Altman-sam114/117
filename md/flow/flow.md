...
6. `JournalStatistics` 对每篇日记只构造一次 `JournalEntryBodySummary`，单轮聚合总篇数、总词数、平均词数、小节覆盖率、连续天数、本周数据、分类分布、心情分布、分布最大 entry count、最近 7 天趋势和趋势最大词数。
