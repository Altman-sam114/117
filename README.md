...
- 2026-08-09：v0.76 将筛选状态和 `JournalEntryListSnapshot` 提升到 `ContentView`，列表、详情、selection repair、创建/删除修复和 Mac Catalyst 较新/较早导航统一消费可见 `filteredEntries`；新增 6 项纯 `JournalEntrySelectionPolicy` 与筛选删除/新建/导航测试。实现 HEAD `d3b11c3b63ea4af8d94dfbe1bc4d660766c06627` 对应 run `31296673536` attempt `1` 的未加密 artifact `mdjournal-ci-v0.76-main-d3b11c3-run31296673536-attempt1`（ID `9033210493`，size `437199`，digest `sha256:86755783b134e7b1ee6ad1c2db1b7d20f1b99476ba7b87e7f445ba60c49b425f`）已由 Agent C PASS，`195 passed / 0 failed / 0 skipped`，6 项新增测试各执行一次；文档收敛新 HEAD 尚未产生云端结果，真实 UI 时序与辅助功能仍需人工验收。
