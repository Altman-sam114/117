...
- Markdown 编辑器，带 `###` 小节、加粗、引用、列表、待办、代码块和分割线快捷按钮；Mac Catalyst 下也可从“插入 Markdown”菜单和键盘快捷键追加片段。
...
- Mac Catalyst 下保留列表、编辑器、预览和统计主流程，并补充右键删除、“日记”菜单、`⌘N` 新建、独立统计窗口和 Markdown 片段菜单入口。
