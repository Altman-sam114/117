...
- 2026-08-23：v0.78 将 `JournalEntryBodyMetrics` 的词数和完整 `###` 小节派生收敛到模型层共享单次正文扫描；保留 v0.77 的换行、marker、trim、EOF、fenced code 和旧词数语义，新增精确 metrics characterization。当前实现待提交、待 push、待 GitHub Actions artifact 验收；本机未运行 build、XCTest、模拟器或 app。
